    ...
    <style>
       html, body {
        ...
        .bg {
            ...
            background-image: url("images/C_Noodles_BK.jpg");
            height: auto;
...
<%@ include file="Header.jsp" %> 
        ...
        <div >
            <h1 align=center style="font-size:300%; font-family:Comic Sans MS; color: brown">Chinese Noodle Dishes</h1>
