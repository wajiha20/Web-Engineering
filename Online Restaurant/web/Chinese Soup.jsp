...
<html>
    ...
    <style>
        ...
        .bg {
            ...
            background-image: url("images/C_Soups_BK.jpg");
            height: auto;
...
<%@ include file="Header.jsp" %> 
        ...
        <div >
            <h1 align=center style="font-size:300%; font-family:Comic Sans MS; color: black">Chinese Soups</h1>
