...
<html>
    ...
    <style>
       html, body {
        ...
        .bg {
            ...
            background-image: url("images/Bengoli BK.JPG");
            height: auto;
    ...
    <body class="bg">
        ...
        <div>
            <h1 align=center style="font-size:300%; font-family:Comic Sans MS; color: black">Bengoli</h1>
                ...
                <tr> 
                    ...
                    <td>
                        <form action="AddToCart.jsp"> 
                            ...
                            <b style="font-size:100%; font-family:Comic Sans MS; color: black"><input type="hidden" name="item" value="<%=rs4.getString("itemName")%>"><%=rs4.getString("itemName")%><br>
